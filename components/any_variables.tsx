...
export const level5 = "h3_patientzero_" + ratingdropdown + "_" + diffdropdown
...
export const level13 = "h3_freeform_" + ratingdropdown + "_" + diffdropdown
export const level14 = "h3_finaltest_" + ratingdropdown + "_" + diffdropdown
...
export const level29 = "h3_landslide_" + ratingdropdown + "_" + diffdropdown
export const level30 = "h3_icon_" + ratingdropdown + "_" + diffdropdown
export const level31 = "h3_ahbos_" + ratingdropdown + "_" + diffdropdown
export const level32 = "h3_source_" + ratingdropdown + "_" + diffdropdown
export const level33 = "h3_author_" + ratingdropdown + "_" + diffdropdown
export const level34 = "h3_vector_" + ratingdropdown + "_" + diffdropdown
export const level35 = "h3_pzhokkaido_" + ratingdropdown + "_" + diffdropdown
...
export const level43 = "h3_s6_" + ratingdropdown + "_" + diffdropdown // full game cat added late, broke pattern sadge
export const level44 = "h3_director_s6_" + ratingdropdown + "_" + diffdropdown
export const level45 = "h3_enforcer_s6_" + ratingdropdown + "_" + diffdropdown
export const level46 = "h3_extractor_s6_" + ratingdropdown + "_" + diffdropdown
export const level47 = "h3_veteran_s6_" + ratingdropdown + "_" + diffdropdown
export const level48 = "h3_mercenary_s6_" + ratingdropdown + "_" + diffdropdown
export const level49 = "h3_controller_s6_" + ratingdropdown + "_" + diffdropdown
