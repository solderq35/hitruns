...
const IndexPage = (): JSX.Element => (
    <Layout title="Guides || HitRuns" headerText="HITMAN SPEEDRUNS">
        ...
        <p>
            <p>
                Download Livesplit{" "}
                <a href="https://livesplit.org/downloads/" target="blank">
                    here
                </a>
            </p>
            <p>
                Unzip the folder of the Livesplit Download, and then click on
                the Livesplit Application to start.
            </p>
            <p>
            ...
            <p>
                <a
                    href="https://i.ibb.co/TrJWrq5/splitsedit.png"
                    target="blank"
                >
            ...
            <p>
                Click on the "+" symbol again, then go to "Control", then
                "Manual Game Time".
            </p>
            <p>
                <a
                    href="https://i.ibb.co/Mn4qC8w/editlayout.png"
                    target="blank"
                >
            ...
            <p>
                ...
                Lock on) is the default for starting and splitting, if you have
                followed the steps above, hitting the Numpad 1 key will bring up
                a prompt to enter game time manually. Type your time for the
                given level in and hit Enter key to save the split time for the
                level. Repeat after each level.
            </p>
            <p>
                <a
                    href="https://i.ibb.co/zsGmxJf/entergametime.png"
                    target="blank"
                >
            ...
            <p>
                Do not X out or minimize the "Enter Game Time" window as this
                may cause problems.
            </p>
