...
import { requestRuns } from "../lib/h3_snowfestival_any_run"

const linkname = "h3_snowfestival"
const category = "Snow Festival [Peacock]"
const rating = "Any%"
const diff = ""
...
const level13 = "h3_icon_" + ratingdropdown + "_" + diffdropdown
