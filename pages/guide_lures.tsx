...
<p>Disclaimer- Guide ported from H2. The tricks here seem to work in H3 as well so far based on personal testing, but keep in mind some small things may be altered.</p>
    <p>
      <strong>For bullet lures, refer <a href="https://www.speedrun.com/just_hitman_2/guide/ig9m0"  target="blank">here</a></strong>
    </p>
    ...
    <ul>
      <li>
        <a href="https://youtu.be/7Sl5YjZk9RQ?t=152"  target="blank">Example</a>: Peekaboo Cassidy into yard for easy kill.</li>
    </ul>
    <p>You can make the peekaboo stronger by aiming a gun at the target; this enables long distance lures.</p>
    <ul>
      <li>
        <a href="https://youtu.be/rtOxUR7SW6k?list=PLflusD4O8jzP3x-aiUsCupSy0iWm8Sq1G&amp;t=115"  target="blank">Example</a>: Tyson is lured downstairs with gun peekaboo for a falling object kill.</li>
    </ul>
    <h2 id="briefcase">Briefcase</h2>
    <p>
      <strong>For more info on what explosives work with briefcase, check <a href="https://imgur.com/a/VdQnRVm"  target="blank">here</a></strong>
    </p>
    ...
    <ul>
      <li>
        <a href="https://youtu.be/1_jXK9Pbg8E?t=107"  target="blank">Example</a>: Briefcase dropped to lure Tyson downstairs for falling object kill.</li>
    </ul>
    ...
    <ul>
      <li>
        <p>
          <a href="https://www.youtube.com/watch?v=GCICN86wF9M&amp;feature=youtu.be"  target="blank">Example 1</a>: Briefcase breaks the peekaboo of Tyson for a potential lure to the cylindrical lamp for an electrocution kill.</p>
      </li>
      <li>
        <p>
          <a href="https://youtu.be/xbYaP_6clQQ?t=128"  target="blank">Example 2</a>: An initial bullet distraction turns the target to look in the direction of the briefcase, and then the briefcase takes priority over the bullet distraction. The target walks over to pick up briefcase, making for an easy explosive kill.</p>
      </li>
    </ul>
...
Coins are not unique in their ability to be placed on the ground and lure people. The following list of items (which is not exhaustive) also can lure NPC's passively when placed.</p>
    ...
    <ul>
      ...
      <li>
        <a href="https://youtu.be/NjJexxqp_c0?t=48"  target="blank">Example 1</a>: Note how the dart gun click lures an NPC through the wall.</li>
      <li>
        <a href="https://youtu.be/YKmnASBZl74?t=218"  target="blank">Example 2</a>: Note how the dart gun click turns the enforcer around.</li>
    </ul>
    ...
    <ul>
      ...
      <li>
        <a href="https://youtu.be/gp_m9OzlHl0?t=45"  target="blank">Example</a>: Drop briefcase to stop guards from walking into puddle after hearing bullet.</li>
    </ul>
