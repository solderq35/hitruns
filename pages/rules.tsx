...
const IndexPage = (): JSX.Element => (
    <Layout title="Hitman 3 Run Rules | HitRuns" headerText="HITMAN SPEEDRUNS">
        <center>
            ...
            <p className="class9">
                Reminder: This site is just a mirror of speedrun.com, to ensure
                your run appears on the leaderboard, go to speedrun.com to
                submit your run.
            </p>
        </center>
        ...
        <p>
            <ul>
                ...
                <li>
                    Season 2 w/ DLC: 8 levels from Hawke's Bay to Haven (in
                    order)
                </li>
                <li>Season 1: 6 levels from Paris to Hokkaido (in order)</li>
                <li>
                    Trilogy Campaign: 6 levels of Season 1, 8 levels of Season 2
                    with DLC, 6 levels of Season 3. 20 levels from Paris to
                    Romania. (in order)
                </li>
                <li>
                    Patient Zero: 4 levels of Source, Author, Vector, PZ
                    Hokkaido (in that order)
                </li>
                <li>
                    Season 2 (no DLC): 6 levels from Hawke's Bay to Sgail (in
                    order)
                </li>
            </ul>
        </p>
        ...
        <p>
            <ul>
                <li>
                    ...
                    >
                        {" "}
                        Grun Time Calculator
                    </a>
                    .
                </li>
                <li>
                    If you reset, add the time on the timer HUD to the total in
                    game time
                </li>
                <li>
                    ...
                    bug), or you get the unskippable syringe cutscene bug in
                    Romania, but the rating screen still shows "Silent
                    Assassin", then use the last seen timer HUD time + 1 second
                    for that level.
                </li>
                <li>
                    If rating screen time is missing, then use the last seen
                    timer HUD time + 1 second for that level. (Only for any%
                    runs, if SA or SASO runs have no rating screen, they won't
                    be accepted).
                </li>
            </ul>
        </p>
        ...
        <p>
            <ul>
                <li>
                    Timing starts when the player ends the opening cutscene of
                    the first mission, and timing ends when exit prompt is
                    pressed on final mission.
                </li>
            </ul>
        </p>
        ...
        <p>
            <ul>
                <li>
                    Use the time on the level's rating screen (in game time)
                </li>
                <li>
                    If rating screen time is negative (
                    <a
                ...
                <li>
                    If rating screen time is missing, then use the last seen
                    timer HUD time + 1 second. (Only for any% runs, if SA or
                    SASO runs have no rating screen, they won't be accepted).
                </li>
            </ul>
        </p>
        ...
        <p>
            <ul>
                <li>
                    "Silent Assassin" text on the rating screen (non-negotiable)
                </li>
                <li>
                    SA runs can be performed on professional or master
                    difficulty
                </li>
            </ul>
        </p>
        ...
        <p>
            <ul>
                ...
                <li>
                    Any% runs can be performed on any difficulty including
                    casual.
                </li>
            </ul>
        </p>
        ...
        <p>
            <ul>
                ...
                <li>
                    ...
                    >
                        {" "}
                        24 hour in game timer overflow exploit
                    </a>
                    .
                </li>
