...
const IndexPage = (): JSX.Element => (
    ...
    <ul>
      <li>There are some categories in Category Extensions that comes close to simulating a New Game experience, you can check the leaderboards <a href="https://www.speedrun.com/hitman_3_extensions/full_game">here</a>. Click on "Default Loadout/Start (NG)" or "Default Loadout/Start (NG+)" and then click "View Rules" if confused about the rules.</li>
    ...
    <p>Q: Okay, say I'm willing to try the NG+ categories, how do I level up quickly to get the item and starting location unlocks?
	A: First of all, if you are PC, consider using <a href="https://rentry.org/h3_peacock_installation">The Peacock Project</a>. This tool will allow you to get access to all unlocks right away.</p>
    <ul>
      <li>If you are on console or do not wish to use Peacock, take a look at <a href="https://hitman.fandom.com/wiki/List_of_mastery_unlocks_by_mission">this list of unlocks</a> first, so you know what you need to do to get a certain item.</li>
