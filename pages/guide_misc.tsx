...
<p>Disclaimer- Guide ported from H2. The tricks here seem to work in H3 as well so far based on personal testing, but keep in mind some small things may be altered.</p>
    ...
    <ul>
      ...
      <li>
        <p>
          <a href="https://youtu.be/F5SXFdx04pI?t=18">Example</a>: This player played about 20 seconds of cutscene. As a result Maya Parvarti walked under the hay bale at 1:41. Without waiting cutscene Parvarti walks under hay bale at about 2 minutes.</p>
      </li>
    </ul>
    ...
    <ul>
      ...
      <li>
        <a href="https://youtu.be/ou48fdLsmZQ?t=17">Example</a>. This saves about half a second overall.</li>
    </ul>
    <h3 id="unlocking-doors">Unlocking Doors</h3>
    <p>Some of the methods of unlocking doors were covered <a href="https://www.speedrun.com/hitman_3/guide/h5jij">here</a>, but I will go more into depth on the topic here as well.</p>
    ...
    <ul>
      ...
      <li>
        <p>
          <a href="https://youtu.be/Wozdp8NAvvQ?t=16">Example</a>.  Note that Krugermeier and Hwk 21 Homemade may need more shots to work with this trick.</p>
      </li>
      <li>
    ...
    <ul>
      <li>
        <a href="https://youtu.be/rLJJKdxbMas?t=46">Example</a>
      </li>
...
hope this helps</p>
    ...
    <ul>
      <li>
        <a href="https://youtu.be/hxXunF1WkeM?t=57">Example 1</a>: Slow disguise change animation (where 47 runs his hands along each arm). This happens sometimes if you are standing when you take disguise. Avoid this at all costs!</li>
      <li>
        <a href="https://youtu.be/B-T12TJfHBM?t=44">Example 2</a>: Notice how 47 does a faster animation without running his hands along his arms.</li>
      <li>
        <a href="https://youtu.be/2HGNgKRJMdc?t=55">Example 3</a>: Grabbing body before disguise change is also a way to avoid the slow disguise change animation. Note this works even if you are standing up before grabbing body.</li>
    </ul>
    ...
    <ul>
      <li>
        <a href="https://youtu.be/KPA9t3FVysA?t=22">Example</a>
      </li>
    </ul>
    ...
    <ul>
      <li>
        <a href="https://youtu.be/E27yVaESkTY">Example</a> (strafe left, cycle inventory to the right)</li>
    </ul>
...
<a href="https://youtu.be/gH1o5VsJqh4">Example</a></p>
</p>
	</p>
