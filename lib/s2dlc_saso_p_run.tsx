...
export const requestRuns: any = async () => {
  ...
  let response: [string] = [await axios.get('https://www.speedrun.com/api/v1/leaderboards/j1ne5891/category/9kv6n132?var-j84eq0wn=21g85yxl&var-5lypzk9l=4qyp9g6q&var-78962g08=p12dkr2q&embed=platforms%2Cplayers&timing=realtime_noloads')];
