...
export const requestRuns: any = async () => {
  ...
  let response: [string] = [await axios.get('https://www.speedrun.com/api/v1/leaderboards/j1ne5891/category/9kv6n132?var-j84eq0wn=gq7jpknq&var-5lypzk9l=mlnw9jol&var-78962g08=p12dkr2q&embed=platforms%2Cplayers&timing=realtime_noloads')];
